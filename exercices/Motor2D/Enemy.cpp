...
Enemy::Enemy(int x, int y, EntityType type) : Entity(x, y, type) {
	...
	death_1 = App->audio->LoadFx("audio/fx/death_1.wav");
	death_2 = App->audio->LoadFx("audio/fx/death_2.wav");
	death_3 = App->audio->LoadFx("audio/fx/death_3.wav");
}
...
Enemy::~Enemy()
{
	...
	App->audio->UnLoadFx(death_1);
	App->audio->UnLoadFx(death_2);
	App->audio->UnLoadFx(death_3);
}
